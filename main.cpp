 ...
 *
 * Informativa:
 *  1. Il compito deve essere consegnato su Google Drive all'indirizzo che verrà
 *      dato entro 5 minuti, la mancata consegna entro il termine stabilito comporterà
 *      una votazione equivalente a NC
 *
 ...
 *      Leggi il codice!!!!!!!
 *      No scherzo:
 *      Un'azienda (supermercato) ha chiesto un sistema automatico per la creazione dell'anagrafica dei propri
 *      clienti.
 *      Il vostro PR (Project Manager), che non sa programmare, vi consegna questi file, dopo esservi messi le
 *      mani nei capelli e tirato giù qualche essere celeste, vi viene detto che la demo è stata fissata tra
 *      tre ore (momento di panico).
 *      L'obiettivo vostro è di non far fallire l'azienda: la Di Sabatino International Corporation,
 *      per questo venite ingaggiati per completare le seguenti librerie.
